export const appointments = [
    {
      ...
      startDate: new Date(2021, 4, 4, 9, 35),
      endDate: new Date(2021, 4, 4, 11, 30),
      id: 0,
      participants: [
        {
      ...
      startDate: new Date(2021, 4, 5, 12, 0),
      endDate: new Date(2021, 4, 5, 13, 0),
      id: 1,
      location: 'Room 1',
    }, {
      title: 'Install New Router in Dev Room',
      startDate: new Date(2021, 4, 6, 14, 30),
      endDate: new Date(2021, 4, 6, 15, 35),
      id: 2,
      location: 'Room 2',
    }, {
      title: 'Approve Personal Computer Upgrade Plan',
      startDate: new Date(2021, 4, 7, 10, 0),
      endDate: new Date(2021, 4, 7, 11, 0),
      id: 3,
      location: 'Room 2',
    }
  ];
